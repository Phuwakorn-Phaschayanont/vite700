...
const TitleLink = ({ isHighLight, title, link }) => {
          ...
          if (!link) {
                  return <div className={`text-primaryAccent font-medium ${isHighLight ?"text-primaryTitle":""}`}></div>
          }
          return(
              
              <div className={`text-primaryAccent font-medium ${isHighLight ?"text-primaryTitle":""}`}>
